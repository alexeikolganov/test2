...
public class HFilePane extends JPanel implements PropertyChangeListener {

    /**
	 * 
	 */
	private static final long serialVersionUID = -5088297379522854683L;
    ...
    private final static Font FONT = new Font( "Segoe UI", Font.PLAIN, 12 );
    ...
    public HFilePane( FileChooserUIAccessor fileChooserUIAccessor) {
    ...
    class ViewTypeAction extends AbstractAction {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 7037612235980469199L;
    ...
    protected void installDefaults() {
        ...
        readOnly             = true; //UIManager.getBoolean("FileChooser.readOnly");
    ...
    /**
     * Fetches the command list for the AFilePane. These commands
    ...
    public Action[] getActions() {
        if (actions == null) {
            class AFilePaneAction extends AbstractAction {
                /**
				 * 
				 */
				private static final long serialVersionUID = -7442487028901516385L;

				AFilePaneAction(String name) {
                    this(name, name);
                }

                AFilePaneAction(String name, String cmd) {
                    super(name);
                    putValue(Action.ACTION_COMMAND_KEY, cmd);
                }
            ...
            actionList.add(new AFilePaneAction(ACTION_CANCEL));
            actionList.add(new AFilePaneAction(ACTION_EDIT_FILE_NAME));
            actionList.add(new AFilePaneAction(refreshActionLabelText, ACTION_REFRESH));
	...
	public JPanel createList() {
        ...
        final JList list = new JList() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 1900983383587319054L;
        ...
        scrollpane.setVerticalScrollBar( new HScrollBar( JScrollBar.VERTICAL ) );
        scrollpane.setHorizontalScrollBar( new HScrollBar( JScrollBar.HORIZONTAL ) );
    ...
    private class SortableListModel extends AbstractListModel
		 ...
		 * 
		 */
		private static final long serialVersionUID = -7310252258546338849L;
    ...
    class DetailsTableModel extends AbstractTableModel implements ListDataListener {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -6357244234308481055L;
		...
		void updateColumnInfo() {
            ...
            //System.out.println(allColumns[3].getTitle());
            ...
            if (col == COLUMN_FILENAME) {
                ...
                if (f != null) {
                    ...
                    if (!newDisplayName.equals(oldDisplayName)) {
                        ...
                        if (!f2.exists()) {
                            if (HFilePane.this.getModel().renameFile(f, f2)) {
    	...
    	if (table != null) {
            ...
            if( header != null )
            {
            	 header.setDefaultRenderer( new DefaultTableCellHeaderRenderer() {
     				private static final long serialVersionUID = -3028378870484668360L;
                     ...
                     public Component getTableCellRendererComponent(
                         ...
                         rendererComponent.setBackground( new Color( 150, 150, 150 ) );
                         rendererComponent.setBorder( BorderFactory.createEmptyBorder(4, 4, 4, 0) );
    ...
    private class DetailsTableRowSorter extends TableRowSorter {
        ...
        private class SorterModelWrapper extends ModelWrapper {
            ...
            public Object getValueAt(int row, int column) {
                return HFilePane.this.getModel().getElementAt(row);
            }
    ...
    private class DetailsTableCellEditor extends DefaultCellEditor {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -7925102182217205596L;
    ...
    class DetailsTableCellRenderer extends DefaultTableCellRenderer {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 4648458954846688447L;
		JFileChooser chooser;
        DateFormat df;
        ...
        public Component getTableCellRendererComponent(JTable table, Object value,
            ...
            final Color SELECTED_COLOR = new Color( 225, 225, 225 );
            final String DIRECTORY_ICON = "icons/directory.png";
            final String FILE_ICON = "icons/file.png";
            ...
            if (value == null) {
                ...
                setBackground( (isSelected) ? SELECTED_COLOR : BACKGROUND_COLOR );
                setBorder( BorderFactory.createEmptyBorder( 0, 4, 0, 0) );
                //setPreferredSize(new Dimension( 500, 24 ));
                setFont( FONT );  
                File imgFile = new File( FILE_ICON );
            	if( file.isDirectory() )
            	{
            		imgFile = new File( DIRECTORY_ICON );
            	}
    ...
    public JPanel createDetailsView() {
        ...
        final JTable detailsTable = new JTable(getDetailsTableModel()) {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 6441305253453617539L;
       ...
       //         new AlignableTableHeaderRenderer(detailsTable.getTableHeader().getDefaultRenderer());
        ...
        updateDetailsColumnModel( detailsTable );
    
        JScrollPane scrollpane = createScrollPane( detailsTable );
        scrollpane.setVerticalScrollBar( new HScrollBar( JScrollBar.VERTICAL ) );
        scrollpane.setHorizontalScrollBar( new HScrollBar( JScrollBar.HORIZONTAL ) );
    ...
    public Action getNewFolderAction() {
        if (!readOnly && newFolderAction == null) {
            newFolderAction = new AbstractAction(newFolderActionLabelText) {
				 ...
				 * 
				 */
				private static final long serialVersionUID = 5783997596954065524L;
				private Action basicNewFolderAction;

                // Initializer
                {
                    putValue(Action.ACTION_COMMAND_KEY, HFilePane.ACTION_NEW_FOLDER);
    ...
    protected class FileRenderer extends DefaultListCellRenderer  {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 2520649926624469711L;
		final Color BACKGROUND_COLOR = Color.WHITE;
        final Color SELECTED_COLOR = new Color( 225, 225, 225 );
        final String DIRECTORY_ICON = "icons/directory.png";
        final String FILE_ICON = "icons/file.png";
    ...
    private void setStyling( JScrollPane scrollpane )
    {
